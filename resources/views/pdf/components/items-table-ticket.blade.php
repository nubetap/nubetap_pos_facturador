        ...
        @forelse($detalles as $index => $detalle)
            <div class="item">
                ...
                <div class="item-details">
                    {{ number_format($detalle['cantidad'] ?? 0, 2) }} {{ $detalle['unidad'] ?? 'NIU' }} x {{ number_format($detalle['mto_precio_unitario'] ?? $detalle['mto_valor_unitario'] ?? 0, 2) }} = {{ number_format(($detalle['mto_precio_unitario'] ?? $detalle['mto_valor_unitario'] ?? 0) * ($detalle['cantidad'] ?? 0), 2) }}
                </div>
            </div>
        @empty
            <div class="item">
