...
return new class extends Migration
{
    public function up(): void
    {
        ...
        // PostgreSQL no soporta ENUM directamente en ALTER TABLE como MySQL
        // En su lugar, validaremos que solo existan los tipos permitidos
        // Los ENUMs en PostgreSQL deben manejarse diferente o usar CHECK constraints
    ...
    {
        // No se requiere revertir cambios de ENUM en PostgreSQL
        // Los registros eliminados se pueden recrear si es necesario
    }
};